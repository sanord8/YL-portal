  ...
  <div class="bg-white border-b mb-6">
    <div class="flex space-x-8 overflow-x-auto">
      ...
      <a
        ...
        class="px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap"
        class:border-yl-green={window.location.pathname.startsWith('/admin/bank-accounts')}
        class:text-yl-green={window.location.pathname.startsWith('/admin/bank-accounts')}
        class:border-transparent={!window.location.pathname.startsWith('/admin/bank-accounts')}
        class:text-yl-gray-600={!window.location.pathname.startsWith('/admin/bank-accounts')}
        class:hover:text-yl-gray-900={!window.location.pathname.startsWith('/admin/bank-accounts')}
      >
        Bank Accounts
      </a>
      <a
        href="/admin/bank-movements"
        class="px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap"
        class:border-yl-green={window.location.pathname.startsWith('/admin/bank-movements')}
        class:text-yl-green={window.location.pathname.startsWith('/admin/bank-movements')}
        class:border-transparent={!window.location.pathname.startsWith('/admin/bank-movements')}
        class:text-yl-gray-600={!window.location.pathname.startsWith('/admin/bank-movements')}
        class:hover:text-yl-gray-900={!window.location.pathname.startsWith('/admin/bank-movements')}
      >
        Bank Movements
      </a>
